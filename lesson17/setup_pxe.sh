...
#  append initrd=images/CentOS-8/initrd.img ip=enp0s3:dhcp inst.repo=http://10.0.0.20/centos8-install
  append initrd=images/CentOS-8/initrd.img ip=enp0s3:dhcp inst.repo=http://10.0.0.20/centos8-initrd
...
curl -O http://repos-va.psychz.net/centos/8.3.2011/BaseOS/x86_64/os/images/pxeboot/initrd.img
curl -O http://repos-va.psychz.net/centos/8.3.2011/BaseOS/x86_64/os/images/pxeboot/vmlinuz
cp {vmlinuz,initrd.img} /var/lib/tftpboot/pxelinux/images/CentOS-8/
mkdir /mnt/centos8-initrd
cp {vmlinuz,initrd.img} /mnt/centos8-initrd
...
curl -O http://repos-va.psychz.net/centos/8.3.2011/isos/x86_64/CentOS-8.3.2011-x86_64-minimal.iso
#curl -O http://repos-va.psychz.net/centos/8.3.2011/isos/x86_64/CentOS-8.3.2011-x86_64-dvd1.iso
...
# nginx будет давать доступ к /mnt
...
#  curl -O http://ftp.mgts.by/pub/CentOS/8/BaseOS/x86_64/os/images/boot.iso
  curl -O http://repos-va.psychz.net/centos/8.3.2011/BaseOS/x86_64/os/images/boot.iso
